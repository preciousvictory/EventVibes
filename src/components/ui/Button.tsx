...
const AnimatedButton: React.FC<ButtonProps> = ({
  ...
  const baseClasses = `
    px-4 py-3 cursor-pointer inline-flex text-center items-center justify-center whitespace-nowrap rounded-full text-sm font-regular ring-offset-white transition-colors 
